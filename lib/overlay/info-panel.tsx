...
export function InfoPanel() {
  return (
    <Card className="leading-loose flex flex-col gap-2 ">
      <Title>Monitoring Oregon&apos;s Last Remaining Old Growth Forests</Title>
      <Text>
      ...
      <Text>
        ...
        forests are" has historically contributed to plausiable deniability for
        the harvest of Old Growth in Oregon, as recently as in 2019. While Old
        Growth locations are not perfectly understood or mapped in Oregon or
        across the country, there are a few adjacent or direct efforts underway
        to do so.
      ...
      <Text>
        ...
        Among other limitations, this map
